        ...
        <div className="flex items-start justify-between gap-3 sm:gap-4">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              {audit.engineProfile && (
                <span className="inline-flex items-center gap-1 text-xs px-1.5 py-0.5 rounded-md bg-theme-tertiary text-theme-secondary">
                  {audit.engineProfile === "comprehensive" ? "Comprehensive" : "Strict"}
                </span>
              )}
            </div>
          </div>
