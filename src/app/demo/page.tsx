          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            {result.safeMode && (
              ...
              >
                ...
                <div>
                  <h3 className="text-sm font-semibold mb-1" style={{ color: 'var(--severity-moderate)' }}>Partial Scan Results</h3>
                  <p className="text-sm text-theme-secondary">
                    This site&apos;s complexity required a reduced scan. Color contrast checks were skipped to complete the analysis.
                  </p>
                </div>
              </div>
            )}
