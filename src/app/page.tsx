      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center mb-14">
          ...
          <p className="text-theme-secondary max-w-2xl mx-auto">
            Four simple steps to help your website flourish
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {[
            ...
            {
              step: "4",
              title: "Save Your Bounty",
              description: "Sign in to store results publicly in the community garden or privately in your dashboard.",
              icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="relative overflow-hidden rounded-3xl bg-[var(--accent-bg)] border border-[var(--accent-border)] p-12 lg:p-16">
          ...
          <div className="relative text-center max-w-2xl mx-auto">
            ...
            <Link href="/database" className="btn-primary btn-primary-prominent">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
